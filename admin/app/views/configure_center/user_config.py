...
@app.route('/next_console_admin/config_center/user_config/get', methods=['GET', 'POST'])
@jwt_required()
def user_config_get():
    """
    获取用户配置
...
@app.route('/next_console_admin/config_center/user_config/update', methods=['GET', 'POST'])
@jwt_required()
