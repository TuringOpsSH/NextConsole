...
@app.route('/next_console_admin/attachment/base_init', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/add_into_session', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/remove_from_session', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/search_in_session', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/get_detail', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/add_webpage_tasks', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/search_resources', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/search_resources_by_rag', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/search_share_resources', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/add_resources_into_session', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/attachment/get_all_resource_formats', methods=['GET', 'POST'])
@jwt_required()
