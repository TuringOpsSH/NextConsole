...
@app.route('/next_console_admin/resources/object/search', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/search_by_keyword_in_resource', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/get_path', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/get', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/upload_task/add', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/upload_task/update', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/upload', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/delete', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/batch_delete', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/add', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/batch_add_folder', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/update', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/download', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/batch_download', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/object/move', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/usage/get', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/ref/build', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/ref/rebuild', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/resource_recent_count', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/search_by_recent_upload', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/resource_type_count', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/resource_recent_format_count', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/search_by_recent_index', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/search_by_resource_type', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/search_by_resource_tags', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/search_by_resource_keyword', methods=['GET', 'POST'])
@jwt_required()
