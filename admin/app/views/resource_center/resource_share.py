...
@app.route('/next_console_admin/resources/share_object/get_access_list', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/update_access_list', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/get_list', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/get_meta', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/check_access', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/search_by_keyword', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/share_object/search_by_keyword_in_resource', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/cooling_record_detail', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/cooling_record_update', methods=['GET', 'POST'])
@jwt_required()
