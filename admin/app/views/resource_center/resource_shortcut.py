...
@app.route('/next_console_admin/resources/shortcut/add', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/shortcut/search', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console_admin/resources/shortcut/delete', methods=['GET', 'POST'])
@jwt_required()
