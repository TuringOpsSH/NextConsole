...
export const api = {
  ...
  twadmin_create_user_by_excel: envUrl + '/next_console_admin/management_center/management/user/add_user_by_excel_twadmin'
};
...
export function create_user(params: object): Promise<ServerResponse> {
  return request({
    url: api.create_user,
    data: params,
    responseType: 'json'
...
export async function get_user(params: object) {
  const res: ServerResponse = await request({
    url: api.get_user,
    data: params,
    responseType: 'json'
  });
...
export async function create_role(params: object): Promise<ServerResponse> {
  return request({
    url: api.create_role,
    data: params,
    responseType: 'json'
...
export function update_role(params: object): Promise<ServerResponse> {
  return request({
    url: api.update_role,
    data: params
  });
...
export function delete_role(params: object): Promise<ServerResponse> {
  return request({
    url: api.delete_role,
    data: params,
    responseType: 'json'
...
export function search_role(params: object): Promise<ServerResponse> {
  return request({
    url: api.search_role,
    data: params,
    responseType: 'json'
...
export function user_login(params: object): Promise<ServerResponse> {
  // 请求token
  return request({
    data: params,
    url: api.login_user,
...
export async function admin_search_user(params: object): Promise<ServerResponse> {
  return request({
...
export async function twadmin_search_user(params: object): Promise<ServerResponse> {
  return request({
...
export async function admin_update_role(params: object): Promise<ServerResponse> {
  return request({
...
export async function twadmin_update_role(params: object): Promise<ServerResponse> {
  return request({
...
export async function admin_archive_user(params: object): Promise<ServerResponse> {
  return request({
