...
import {show_reference_drawer} from '@/components/appCenter/ts/reference-drawer'
import {ResourceItem} from "@/types/resource_type";
import {ref} from "vue";
import {reference_drawer_data} from "@/components/appCenter/ts/reference-drawer";
const drawer_width = ref(window.innerWidth < 768 ? '60vw': '35vw');
</script>
