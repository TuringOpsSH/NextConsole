...
import WorkFlowEdgeEdit from '@/components/appCenter/WorkFlowEdgeEdit.vue';
import WorkFlowNodeEdit from '@/components/appCenter/WorkFlowNodeEdit.vue';
import WorkflowNode from '@/components/appCenter/WorkflowNode.vue';
import AgentApp from '@/components/appCenter/appPreview/AgentApp.vue';
import { currentApp, getWorkFlowSession, showSetPanel } from '@/components/appCenter/ts/app-detail';
import {
  agentAppRef,
  currentEdgeDetail,
  CurrentEditFlow,
