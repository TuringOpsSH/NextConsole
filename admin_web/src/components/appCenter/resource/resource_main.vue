...
import { panel_width, switch_panel } from '@/components/resource/resource_panel/panel';
import Resource_panel from '@/components/resource/resource_panel/resource_panel.vue';

import Welcome_home from '@/components/resource/welcome_home.vue';
