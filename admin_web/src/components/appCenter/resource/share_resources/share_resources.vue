...
import ResourceHead from '@/components/resource/share_resources/resource_head/resource_head.vue';
...
import ContextMenu from '@/components/resource/share_resources/context_menu/context_menu.vue';
...
async function handleSearch() {
  ...
  console.log(111, share_resource_list.value);
}
