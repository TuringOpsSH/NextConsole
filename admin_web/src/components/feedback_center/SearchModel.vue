...
import PromptTest from '@/components/feedback_center/prompt_test.vue';
import {
...
import { admin_favorite, get_session_history_msg, searchSessionLog, searchSessionSourceAPI } from '@/api/feedback_center';
...
async function favoriteHistorySession() {
  ...
  const res = await admin_favorite(params);
  if (!res.error_status) {
...
async function upCheckTargetSession() {
  ...
  const res = await get_session_history_msg(params);
  if (!res.error_status) {
      ...
      <div class="main-area">
        <div class="condition-area">
          ...
          <div class="condition-area-right">
            ...
            <div style="width: 120px">
              <el-input v-model="targetSessionUser" style="width: 120px"
                               placeholder="用户id(数字)" clearable @change="getSessionLog" />
            </div>
            <div style="width: 120px">
        ...
        <div v-loading="sessionLoading" element-loading-text="加载中..." style="margin-top: 12px; width: 100%">
          <el-table :data="currentSessionLogList" show-overflow-tooltip border stripe height="calc(100vh - 200px)">
            ...
            <el-table-column prop="id" label="会话id" width="100" sortable />
            <el-table-column prop="session_source" label="会话来源" width="280">
            ...
            <el-table-column prop="qa_cnt" label="QA数" min-width="100" sortable />
            <el-table-column prop="msg_token_used" label="消耗Token数" min-width="120" sortable />
