    ...
    <el-main style="padding: 0 !important">
      <div id="menu-box">
        <div
            ...
            :key="item.text"
            class="menu-item"
            :class="{ 'menu-item-active': item.is_active === true }"
        ...
        >
          <el-tooltip placement="right" effect="light" :auto-close="3000">
            ...
            <div>
              <el-image v-if="item.is_active" :src="'images/' + item.active_icon" class="menu-icon" />
              <el-image v-else :src="'images/' + item.icon" class="menu-icon" />
            </div>
          </el-tooltip>
        </div>
      </div>
      ...
      <div id="next-console-user-box">
        <el-popover trigger="click" placement="right-end" :width="noticeWidth" :hide-after="0">
          ...
          <div id="system-notice-area">
            ...
            <div
                v-if="unread_system_notice.length > 0 && currentSystemNoticeType == 'unread'"
                id="all-read-button"
            ...
            <el-scrollbar>
              <div style="max-height: 50vh">
                ...
                <div v-else v-infinite-scroll="load_more_notice" class="notice-queue">
        ...
        <el-popover ref="showButtonPop" trigger="click" placement="top-end" width="300px" :hide-after="0">
          <template #reference>
            <div v-if="user_info?.user_id" id="user-avatar">
              <el-avatar v-if="user_info?.user_avatar" :src="get_user_avatar(user_info?.user_avatar)" />
          ...
          <div id="user-button-area">
            ...
            <div id="user-button-list">
              <div
                  v-for="(item, idx) in userButtonData"
                  :key="idx"
            ...
            <div id="logo_out_button" @click="loginOut">
