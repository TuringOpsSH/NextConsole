...
import {
  ...
  bindNewPhoneApi,
  closeUser,
  getSupportArea, getWxConfig,
  listPointTransaction, refreshToken,
  resetNewEmail,
  userUpdate,
  validNewPhoneApi,
  validResetEmailCode
            ...
            <div class="user_info_main">
              <div class="user_info_box">
                    ...
                    <div class="user_info_headers">
                      ...
                      <div class="user-info-meta">
                        ...
                        <el-button
                          ...
                          plain
                          style="height: 35px"
                          @click="localUpdateStatus.close_account = true"
                        >
                          注销账号
                        </el-button>
                      </div>
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <div class="user-info-meta-value" style="overflow: hidden">
