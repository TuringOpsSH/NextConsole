...
import {
  beforeAvatarUpload,
  begin_bind_email,
  begin_bind_phone, begin_bind_wx,
  bind_new_email, bind_new_phone,
  bind_text_code_status, bind_text_code_status_phone,
  bind_text_code_time, bind_text_code_time_phone,
  email_bind_form,
  email_bind_form_ref,
  email_bind_rules,
  email_update,
  ...
  phone_bind_form,
  phone_bind_form_ref, phone_bind_rules,
  phone_update,
  send_bind_code, send_bind_code_phone,
