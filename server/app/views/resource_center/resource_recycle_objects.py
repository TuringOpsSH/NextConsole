...
@app.route('/next_console/resources/recycle_object/search_in_recycle_bin', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/recycle_object/delete', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/recycle_object/recover', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/recycle_object/get', methods=['GET', 'POST'])
@jwt_required()
