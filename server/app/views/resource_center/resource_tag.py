...
@app.route('/next_console/resources/tag/add', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/delete', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/get', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/search', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/update', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/add_resources', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/remove_resources', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources/tag/list_resources', methods=['GET', 'POST'])
@jwt_required()
