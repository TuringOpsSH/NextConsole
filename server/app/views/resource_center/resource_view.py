...
@app.route('/next_console/resources_view/get', methods=['GET', 'POST'])
@jwt_required()
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/download', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/permission', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/users', methods=['GET', 'POST'])
def WPS_view_meta_users():
    ...
    try:
        ...
        app.logger.warning(f'wps-users,认证异常,f{token},{e}')
        return next_console_response(error_status=True, error_code=1001, error_message="资源id")
    user_ids = request.args.getlist('user_ids')
    return wps_get_file_users({"user_ids": user_ids})


@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/upload/prepare', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/upload/address', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/upload/complete', methods=['GET', 'POST'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/upload', methods=['GET', 'POST', 'PUT'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/name', methods=['GET', 'POST', 'PUT'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/versions', methods=['GET'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/versions/<version>', methods=['GET'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/files/<file_id>/versions/<version>/download', methods=['GET'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/object/<key>', methods=['PUT'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/object/<key>/url', methods=['GET'])
...
@app.route('/next_console/resources_view/WPS/v3/3rd/object/copy', methods=['POST'])
