...
@app.route('/next_console/user_center/role_permissions/add', methods=['POST'])
# @permission_required("/next_console/user_center/role_permissions/add")
@jwt_required()
...
@app.route('/next_console/user_center/role_permissions/search', methods=['POST'])
@jwt_required()
...
@app.route('/next_console/user_center/role_permissions/delete', methods=['POST'])
@jwt_required()
