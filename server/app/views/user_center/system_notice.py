...
@app.route("/next_console/get_system_notices", methods=["GET", "POST"])
@jwt_required()
...
@app.route("/next_console/add_system_notices_by_admin", methods=["GET", "POST"])
...
@app.route("/next_console/set_system_notices_read", methods=["GET", "POST"])
@jwt_required()
