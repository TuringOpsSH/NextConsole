...
nohup gunicorn -k geventwebsocket.gunicorn.workers.GeventWebSocketWorker -w 4 --worker-connections 8000 app:app -c next_console_conf.py --pid app/tmp/gunicorn.pid > next_console.log 2>&1 &

nohup python run_celery_worker.py >> celery.log 2>&1 &
nohup python run_celery_worker.py >> celery.log 2>&1 &
nohup python run_celery_worker.py >> celery.log 2>&1 &
nohup python run_celery_worker.py >> celery.log 2>&1 &

nohup python run_celery_beat.py > beat.log 2>&1 &
