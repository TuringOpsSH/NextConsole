...
export const api = {
    assistant_add: envUrl + '/console/assistant_center/assistant_manage/assistants/add',
    assistant_update: envUrl + '/console/assistant_center/assistant_manage/assistants/update',
    assistant_delete: envUrl + '/console/assistant_center/assistant_manage/assistants/delete',
    assistant_search: envUrl + '/console/assistant_center/assistant_manage/assistants/search',
    assistant_get: envUrl + '/next_console/assistant_center/assistant_manage/assistants/get',
    assistant_metric: envUrl + '/console/assistant_center/assistant_manage/assistants/metric/get',
    models_search: envUrl + '/console/assistant_center/assistant_manage/models/search',
    assistant_avatar_upload: envUrl + '/console/assistant_center/assistant_manage/assistants/avatar/upload',
    change_target_assistant: envUrl + '/console/assistant_center/assistant_manage/assistants/change',
    list_shop_assistants: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/listing',
    off_list_shop_assistants: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/off_listing',
    shop_assistant_search: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/search',
    shop_assistant_subscribe: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/subscribe',
    shop_assistant_unsubscribe: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/unsubscribe',
    shop_assistant_switch: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/switch',
    shop_assistant_comment: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/comment',
    shop_assistant_get: envUrl + '/console/assistant_center/shop_assistant_manage/shop_assistants/get',
