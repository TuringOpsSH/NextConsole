...
export async function cancel_subscribe_api(params:object): Promise<ServerResponse> {
    // @ts-ignore
    return request({
...
export async function valid_invite_api(params:object): Promise<ServerResponse> {
    // @ts-ignore
    return request({
