...
export const api = {
  // 资源对象接口
  search_resource_object: envUrl + '/next_console/resources/object/search',
  get_resource_object: envUrl + '/next_console/resources/object/get',
  get_resource_object_path: envUrl + '/next_console/resources/object/get_path',
  add_upload_task: envUrl + '/next_console/resources/object/upload_task/add',
  update_upload_task: envUrl + '/next_console/resources/object/upload_task/update',
  upload_resource_object: envUrl + '/next_console/resources/object/upload',
  delete_resource_object: envUrl + '/next_console/resources/object/delete',
  batch_delete_resource_object: envUrl + '/next_console/resources/object/batch_delete',
  add_resource_object: envUrl + '/next_console/resources/object/add',
  update_resource_object: envUrl + '/next_console/resources/object/update',
  download_resource_object: envUrl + '/next_console/resources/object/download',
  get_resource_usage: envUrl + '/next_console/resources/usage/get',
  move_resources: envUrl + '/next_console/resources/object/move',
  batch_download_resources: envUrl + '/next_console/resources/object/batch_download',
  add_resource_shortcut: envUrl + '/next_console/resources/shortcut/add',
  search_resource_shortcut: envUrl + '/next_console/resources/shortcut/search',
  delete_resource_shortcut: envUrl + '/next_console/resources/shortcut/delete',
  build_resource_object_ref: envUrl + '/next_console/resources/ref/build',
  batch_create_folders: envUrl + '/next_console/resources/object/batch_add_folder',
  upload_resource: envUrl + '/next_console/resources/upload',
  // 资源快捷标签
  get_resource_recent_count: envUrl + '/next_console/resources/resource_recent_count',
  search_resource_by_recent_upload: envUrl + '/next_console/resources/search_by_recent_upload',
  get_resource_recent_format_count: envUrl + '/next_console/resources/resource_recent_format_count',
  get_resource_type_count: envUrl + '/next_console/resources/resource_type_count',
  search_resource_by_recent_index: envUrl + '/next_console/resources/search_by_recent_index',
  search_resource_by_resource_type: envUrl + '/next_console/resources/search_by_resource_type',
  search_resource_by_resource_tags: envUrl + '/next_console/resources/search_by_resource_tags',
  search_resource_by_keyword: envUrl + '/next_console/resources/search_by_resource_keyword',
  // 资源标签
  search_resource_tags: envUrl + '/next_console/resources/tag/search',
  add_resource_tags: envUrl + '/next_console/resources/tag/add',
  update_resource_tags: envUrl + '/next_console/resources/tag/update',
  delete_resource_tags: envUrl + '/next_console/resources/tag/delete',
  // 回收站
  search_resource_in_recycle: envUrl + '/next_console/resources/recycle_object/search_in_recycle_bin',
  search_resource_recycle_object: envUrl + '/next_console/resources/recycle_object/search',
  delete_resource_recycle_object: envUrl + '/next_console/resources/recycle_object/delete',
  recover_resource_recycle_object: envUrl + '/next_console/resources/recycle_object/recover',
  ...
  resource_share_get_list: envUrl + '/next_console/resources/share_object/get_list',
  resource_share_get_meta: envUrl + '/next_console/resources/share_object/get_meta',
  resource_share_check_access: envUrl + '/next_console/resources/share_object/check_access',
  resource_share_search_by_keyword: envUrl + '/next_console/resources/share_object/search_by_keyword',
  resource_cooing_record_detail: envUrl + '/next_console/resources/cooling_record_detail',
  resource_cooling_record_update: envUrl + '/next_console/resources/cooling_record_update',
  search_by_keyword_in_resource: envUrl + '/next_console/resources/object/search_by_keyword_in_resource',
  search_by_keyword_in_resource_share: envUrl + '/next_console/resources/share_object/search_by_keyword_in_resource'
};
