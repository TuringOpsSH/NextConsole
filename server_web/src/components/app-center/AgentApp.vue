...
<template>
  <el-container>
    <el-main :style="mainStyle">
        ...
        <el-row style="width: 100%">
          ...
          <el-col :span="20" :xs="22">
            <div id="message-flow-box" ref="agentFlowBoxRef">
                ...
                <div class="msg-flow-answer-box">
                  ...
                  <div class="msg-flow-answer-content">
                    <div class="msg-flow-answer-inner">
                      <div style="width: 100%" v-html="CurrentAgentApp?.assistant_prologue" />
                    </div>
                  </div>
                </div>
              ...
              <div
                v-for="(item, idx) in AgentAppMsgFlow"
              ...
              >
                ...
                <div class="msg-flow-answer-box" @mouseenter="item.show_button_answer_area = true">
                  <div class="msg-flow-answer-avatar">
                    <el-avatar
                      :src="CurrentAgentApp.assistant_avatar"
                      shape="square"
                  ...
                  <div class="msg-flow-answer-content">
                    <div v-if="QAWorkFlowMap?.[item.qa_id]?.length" class="msg-flow-workflow-box">
                      <div v-show="item?.qa_workflow_open" class="open-workflow-area">
                        <div class="open-workflow-head">
                          <div class="open-workflow-head-left">
                            ...
                            <SimpleProgress v-if="!item.qa_finished" />
                          </div>
                          <div class="open-workflow-head-right">
                            <div class="std-middle-box">
                              <el-image
                                ...
                                @click="item.qa_workflow_open = false"
                              />
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="workflow-list">
                            <div v-for="sub_workflow in QAWorkFlowMap[item.qa_id]" class="sub-workflow-area">
                              ...
                              <div
                                ...
                                v-if="sub_workflow.task_type == '网页解析'"
                        ...
                        <div class="close-workflow-area-left">
                          <div class="std-middle-box">
                            <el-image
                              ...
                              src="/images/ok_green.svg"
                              style="width: 20px; height: 20px"
                            />
                            <el-image
                              v-show="!item?.qa_finished"
                              src="/images/ok_grey.svg"
                              style="width: 20px; height: 20px"
                            />
                          </div>
                          <div class="std-middle-box">
                    ...
                    <div
                      v-if="currentGraphConfigs?.[item.qa_value.question[0]?.msg_id]?.sql"
                      class="msg-flow-graph-box"
                    >
                      <AgentGraph
                        :msg-id="item.qa_value.question[0]?.msg_id"
                    ...
                    <div class="msg-flow-answer-inner" :class="{ 'msg-flow-answer-inner-short': item?.short_answer }">
                      <div
                        v-for="(sub_finish_msg, idx) in item.qa_value.answer[item.qa_value.question[0]?.msg_id]?.[0]
                          ?.msg_content_finish_html"
                        style="width: 100%"
                        @mouseover="showSupDetail(item, $event)"
                        v-html="sub_finish_msg"
                      />
                      <SimpleProgress v-if="item?.qa_finished == false && !item?.qa_workflow_open" />
                      <div v-if="item.qa_value.answer[item.qa_value.question[0]?.msg_id]?.[0]?.msg_is_cut_off">
                ...
                <div class="msg-flow-footer-box">
                  <div class="msg-flow-answer-button-area">
                    ...
                    <div class="msg-flow-answer-button-area-right">
                      ...
                      <div v-if="false" class="msg-flow-answer-button" @click="add_like(item)">
                        <div class="msg-flow-answer-button-icon-box">
                          <el-image
                            v-if="item?.qa_value?.answer?.[item?.qa_value?.question?.[0]?.msg_id]?.[0]?.msg_remark == 1"
                            class="msg-flow-answer-button-icon"
                            src="/images/collect_green.svg"
                          />
                          <el-image v-else class="msg-flow-answer-button-icon" src="/images/collect_grey.svg" />
                        </div>
                      </div>
                  ...
                  <div v-show="item?.qa_finished" class="msg-flow-recommend-area">
                    <div
      ...
      <div
        v-show="scrollToFlag && CurrentAgentAppSession?.id && show_scrollbar_button"
        class="to-bottom-box"
        @click="scrollToQA(1)"
      ...
      <ReferenceDrawer :enable-view="false" />

      <div v-if="showSupDetailFlag" id="sup_detail_box" :style="tooltipStyle" @mouseleave="showSupDetailFlag = false">
        <div class="reference-title">
          <div class="std-middle-box">
            <el-image
              v-if="currentSupDetail?.resource_icon"
              :id="currentSupDetail?.resource_icon"
              :src="currentSupDetail?.resource_icon"
              class="reference-img"
              @error="retry_get_icon(currentSupDetail)"
            >
              <template #error>
        ...
        <div v-show="currentSupDetail?.source_type == 'webpage'" class="reference-text-box">
