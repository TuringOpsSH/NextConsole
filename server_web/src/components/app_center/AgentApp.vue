...
import {
  ...
  tooltipStyle,
} from "@/components/next_console/messages_flow/message_flow";
import {console_input_height} from "@/components/next_console/messages_flow/console_input";
...
import Reference_drawer from "@/components/next_console/messages_flow/reference_drawer.vue";
import Simple_progress from "@/components/next_console/messages_flow/simple_progress.vue";
import {
  AgentAppMsgFlow,
  agentFlowBoxRef,
...
import {
  ...
  showSupDetail,
  showSupDetailFlag
} from "@/components/app_center/ts/agent_console";
import AgentGraph from "@/components/app_center/AgentGraph.vue";
            ...
            >
              <div class="msg-flow-question-box"
                ...
                <div class="msg-flow-question-avatar">
                  <el-avatar v-if="user_info?.user_avatar" :src="user_info?.user_avatar" style="background-color: white"/>
                  <el-avatar v-else style="background: #D1E9FF; cursor: pointer">
                    <el-text style="font-weight: 600;color: #1570ef">
                      {{user_info?.user_nick_name_py}}
                    </el-text>
                  </el-avatar>
