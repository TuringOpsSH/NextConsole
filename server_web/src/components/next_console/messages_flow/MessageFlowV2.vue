...
import SimpleProgress from '@/components/next_console/messages_flow/SimpleProgress.vue';
...
function stopAnswer(data) {
  ...
  msgFlow.value[lastIndex].qa_finished = true;
  try {
    msgFlow.value[lastIndex].qa_value.answer[msgParentId][0].msg_is_cut_off = true;
  } catch (e) {
    console.error(e);
  }
  getTargetReference(msgParentId);
