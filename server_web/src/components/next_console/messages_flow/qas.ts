import {qa_item} from "@/types/next_console";
import {ref} from "vue";
import {current_session} from "@/components/next_console/messages_flow/sessions";
import {user_input} from "@/components/next_console/messages_flow/console_input";
import {create_qa, search_qa} from "@/api/next_console";
