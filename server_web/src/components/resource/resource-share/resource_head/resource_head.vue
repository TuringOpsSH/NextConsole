...
} from '@/components/resource/resource-share/resource_head/resource_head';
import { show_share_resources as showShareResources } from '@/components/resource/resource-share/share_resources';
