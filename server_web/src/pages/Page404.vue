  ...
  <el-scrollbar view-style="width: 100%" wrap-class="width: 100%">
    <div class="main">
      <div class="body">
        ...
        <div>
          <el-text class="content"> 你好像来到了一片荒漠 </el-text>
        </div>
        ...
        <div v-if="is_small_screen" style="display: flex; flex-direction: column; gap: 12px">
          ...
          <div class="std-button" style="background-color: #ffffff; border: 1px solid #d0d5dd" @click="goBefore">
            <div>
              <el-image src="/images/arrow_left_black.svg" style="width: 12px; height: 12px" />
            </div>
            <div>
        ...
        <el-button v-else plain icon="el-icon-back" class="back-btn" @click="goBack">返回首页</el-button>
      </div>
    </div>
  </el-scrollbar>
</template>
