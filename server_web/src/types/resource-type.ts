...
// 资源权限
export type TAuthType = 'read' | 'download' | 'edit' | 'manage';

// 根据指定资源和关键词搜索共享资源入参
export interface ISearchByKeywordsParams {
...
export interface IResourceFormat {
  text: '智能文档' | '多维表格' | '文字' | '演示' | '表格' | 'PDF' | '未知';
  value: 'otl' | 'dbt' | 'doc' | 'ppt' | 'xls' | 'pdf' | '';
  formats: string;
}

export type TResourceListStatus = 'list' | 'card';
